(function() {
    ...
    let cppTexts = {
        youtubeWhat: "What stores and collects Google (the parent company of Youtube)?",
        youtubeWhy: "Why?",

        youtubeVideoWhat: ["Information about activities you do on the internet, such as", "Videos you watch on Youtube", "Interaction with content, such as likes/dislikes or comments"] ,
        youtubeVideoWhy: ["Personalization of content"],
        cppIdVideo: "youtube_Video",

        youtubeAdWhat: ["Information about viewing advertising", "Information about interaction with advertising", "Purchases that you do"],
        youtubeAdWhy: ["Personalize ads", "Publicly share information that does not identify an individual, such as content owners, publishers or developers"],
        cppIdAd: "youtube_Ad"
    };
