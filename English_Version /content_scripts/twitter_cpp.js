(function() {
  ...
  let cppTexts = {
    twitterWhat: "What does Twitter store and collect?",
    twitterWhy: "Why?",
    twitterWhen: "In which situation?",
    twitterBrowse: "If you look at tweets, even if you are not logged in to Twitter",
    twitterBrowseWhat: ["Individual personal information, e.g.", "The type of device you use", "Your IP address"],
    twitterBrowseWhy: ["To personalize content such as displayed tweets", "To match ads to you"],
    cppIdTwitterBrowse: "twitter_browse",
    twitterTweet: "When you write a tweet",
    twitterTweetWhat: ["The content of your tweet"],
    twitterTweetWhy: ["To publish your tweet (in the default settings, the tweet is completely public and the entire internet has access to it)", "To view more relevant content"],
