(function() {
  ...
  let cppTexts = {
     facebookWhat: "What does Facebook store and collect?",
     facebookWhy: "Why?",
     facebookWhen: "In which situation?",

     facebookPost: "If you post something.",
     facebookPostWhatEntries: ["Among other things, the content that you post."],
     facebookPostWhyEntries: ["To share data with other companies in the Facebook group, such as Instagram, Whatsapp, and Oculus",
     "To personalize advertising",
     "To re-use them",
     "To distribute them",
     "To modify them",
     "To copy them",
     "To show or display them publicly",
     "To translate them",
     "To create derivative works"],
     cppIdPost: "facebook_Post",

    facebookEventWhatEntries:["Location-related information, etc.", "Your current location if access is allowed", "Your place of residence", "Places you like to visit", "Companies/people in your area"],
    facebookEventWhyEntries:["For personalized advertising"],
    facebookEvent: "When you sign up for an event.",
    cppIdEvent: "facebook_Event",

    facebookUploadWhat: ["Meta information about uploaded files, such as", "Location of a photo", "Date on which the file was created"],
    facebookUploadWhy: ["To share data with other companies in the Facebook group, such as Instagram, Whatsapp, and Oculus",
     "To use for personalizing content",
      "To use for personalized advertising."],
    facebookUploadMedia: "When uploading pictures, videos or files.",
