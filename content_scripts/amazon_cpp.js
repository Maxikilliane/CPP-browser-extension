(function() {
  ...
  let cppTexts = {
    amazonWhat: "Was speichert und sammelt Amazon?",
    amazonWhy: "Wozu?",

    amazonSearchWhatEntries: ["Deine Bestell- und Inhaltsnutzungshistorie", "Die exakte Reihenfolge der angesehenen/gesuchten Produkte einschließlich Datum und Zeit",
      "Den Standort deines Computers"
    ],
    amazonSearchWhyEntries: ["Um Produkte und Dienstleistungen personalisiert zu empfehlen (Werbung!)", "Um Deine Präferenzen zu ermitteln (Werbung!)"],

    amazonCheckoutWhatEntries: ["Informationen zu deiner Kreditgeschichte"],
    amazonCheckoutWhyEntries: ["Einsatz von Scoring-Verfahren um Deine Zahlungsfähigkeit sicherzustellen"],
